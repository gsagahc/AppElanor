object FrmConsultarLancamentos: TFrmConsultarLancamentos
  ...
  object IBQConsultarLancamentos: TIBQuery
    ...
    object IBQConsultarLancamentosTBCP_MAQUINA: TIntegerField
      FieldName = 'TBCP_MAQUINA'
      Origin = 'TB_CONTROLE_PERDAS.TBCP_MAQUINA'
    end
    object IBQConsultarLancamentosTBCP_DATA: TDateField
      FieldName = 'TBCP_DATA'
      Origin = 'TB_CONTROLE_PERDAS.TBCP_DATA'
    end
    object IBQConsultarLancamentosTBCP_PERCENTUAL: TFloatField
      FieldName = 'TBCP_PERCENTUAL'
      Origin = 'TB_CONTROLE_PERDAS.TBCP_PERCENTUAL'
      DisplayFormat = '#,##0.00'
    end
    object IBQConsultarLancamentosTBPRD_NOME: TIBStringField
